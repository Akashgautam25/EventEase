...
EventEase is a full-stack platform for managing college events. Students can browse and register for events, while admins can create, edit, and manage events from a centralized dashboard. Designed for a clean, responsive, and professional user experience.
